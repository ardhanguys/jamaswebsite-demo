      ...
      <div className="container-custom">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-20">
          {features.map((feature, index) => (
            <div
              key={index}
              className="group p-8 bg-cream rounded-2xl hover:bg-primary transition-all duration-500 hover:shadow-elegant-lg h-full"
            >
        ...
        <div className="bg-cream rounded-2xl p-8 lg:p-12">
          ...
          <div className="flex flex-wrap justify-center gap-3 mb-6">
            {["Sekretaris 1", "Sekretaris 2", "Ketua 2", "Bendahara 1", "Bendahara 2"].map((title) => (
              <div key={title} className="bg-background border-2 border-primary/20 px-4 py-2 rounded-lg font-medium text-primary text-sm text-center shadow-sm">
                {title}
              </div>
            ))}
          </div>
